<div class="wraper">   
       ...
       <!--<small><a href="<?php //echo site_url("paddys/transactions/f_paddycollection_add");?>" class="btn btn-primary" style="width: 100px;">Add</a></small>-->
            <small><a href="<?php echo site_url("paddys/transactions/f_rroupload");?>" class="btn btn-primary" style="width: 100px;">Upload</a></small>
                   ...
                   foreach($rro_dtls as $rro)
                       ...
                       ?>
                        <tr>
                          ...
                          <td><?php echo $rro->rro_number; ?></td>
                          <td><?php echo $rro->cmr_rro; ?></td>
