    <div class="wraper">      
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h1><strong>Yes Bank Cheque Reconciliation</strong></h1>
        ...
        <div class="col-lg-12 container contant-wraper">    
            ...
            <h3>
              ...
              <!--  <small><a href="<?php //echo site_url("paddys/add_new/f_block_add");?>" class="btn btn-primary" style="width: 100px;">Add</a></small> -->
                <small><a href="<?php echo site_url("paddys/transactions/f_cheque_upload");?>" class="btn btn-primary" style="width: 100px;">Upload</a></small>
