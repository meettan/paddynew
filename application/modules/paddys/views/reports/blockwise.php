...
?>        
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" 
                id="form"
                action="<?php echo site_url("paddy/blockwise/report");?>" >

                <div class="form-header">
                
                    <h4>Block Wise Paddy Report</h4>
                ...
                <div class="form-group row">
                    ...
                    <label for="month" class="control-lebel col-sm-2 col-form-label">Select Month:</label>
            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h3>Monthly Block Wise Report For the Month of <?php echo $this->input->post('month');?></h3>
                    ...
                    <table style="width: 100%;">
                        ...
                        <tbody> 
                            ...
                            if($block_grp_cnt) {
                                ...
                                foreach($block_grp_cnt as $d_list) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td rowspan="<?php echo $d_list->count + 1;?>"><?php foreach($block as $dst_list){
                                    ...
                                    foreach ($soc_names as $s_name) {
                                        ...
                                        if($s_name->block == $d_list->block) {

                                            $k = 0;

                                            foreach($blockwise_dtls as $dis_list){
                                    ...
                                    ?>
                                                        ...
                                                        <td rowspan="<?php echo count($blockwise_dtls[$k]);?>" class="span6"><?php foreach($soc as $soc_list){
