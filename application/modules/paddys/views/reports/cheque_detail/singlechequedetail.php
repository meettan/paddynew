...
?>        
    <div class="wraper">      
        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("paddys/transactions/f_singlecheque");?>" >
             ...
             <!--    <div class="form-group row">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row"> 
                    ...
                    <label for="f_payment_cheque" class="col-sm-3 col-form-label">Cheque No:</label>
                    <div class="col-sm-5">
                    
                    <input type="number" name="cheque_no" class="form-control required"> 
            ...
            <div class="col-lg-12 container contant-wraper">
                ...
                <div id="divToPrint">
                    ...
                    <div style="text-align:center;">
                        ...
                        <h4>Cheque Detail of paddy procurement </h4>
                       ...
                       ?>
                        <tr>
                          ...
                          <td ><?php echo ++$count; ?></td>
                           <td ><?php echo $padl_dtl->cheque_no; ?></td>
