        ...
        <div class="col-md-6 container form-wraper">
            ...
            <form method="POST" id="form" action="<?php echo site_url("paddys/transactions/f_reissuechq_add");?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4"><?=$cheque_dtl->cheque_no;?>
            <input type="hidden" class="form-control" name="old_chq_no" id="old_chq_no" value="<?=$cheque_dtl->cheque_no;?>" />
            <input type="hidden" class="form-control" name="trans_id" id="trans_id" value="<?=$cheque_dtl->trans_id;?>" />
             <input type="hidden" class="form-control" name="old_chq_bnk" id="old_chq_bnk" value="<?=$cheque_dtl->bank_sl_no;?>" />
              <input type="hidden" class="form-control" name="book_no" id="book_no" value="<?=$cheque_dtl->book_no;?>" />
                    </div>
